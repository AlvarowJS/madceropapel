...
class TablaEncargaturaDocumentos(Table):
    ...
    def __init__(self, request, *args, **kwargs):
        super(TablaEncargaturaDocumentos, self).__init__(request, *args, **kwargs)
        self.opts.ajax_source = reverse(viewname="apptra:misencargaturas_listar", kwargs={"pt": 0})
