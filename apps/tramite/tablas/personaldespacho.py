...
class TablaPersonalDespacho(Table):
        ...
        toolbar = [
            {
                ...
                "url": reverse_lazy("apptra:personal_bandeja_despacho_firmamasiva"),
                "attrs": {
                    "data-modal-size": "lg",
                    "campo": "1"
                }
            },
            {
                ...
                "modal": "#modal-principal-centro",
                "url": reverse_lazy("apptra:personal_bandeja_despacho_emisionmasiva"),
                "attrs": {
                    "data-modal-size": "lg",
                    "campo": "1"
                }
    ...
    def __init__(self, request, *args, **kwargs):
        super(TablaPersonalDespacho, self).__init__(request, *args, **kwargs)
        self.opts.ajax_source = reverse(viewname="apptra:personal_bandeja_despacho_listar")
