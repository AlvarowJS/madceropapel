...
from apps.tramite.tablas.personalrechazados import TablaPersonalRechazados
...
class PersonalBandejaRechazado(BandejaVista):
    template_name = "tramite/personal/rechazado/vista.html"

    def post(self, request, *args, **kwargs):
        context = self.get_context_data(**kwargs)
        context["TablaPersonalRechazados"] = TablaPersonalRechazados(request=request)
        return self.render_to_response(context=context)


class PersonalBandejaRechazadoListar(BandejaListarFeedDataView):
    table = "tablas.personalrechazados.TablaPersonalRechazados"
    qs = "QueryPersonalBandejaRechazados"


class PersonalBandejaRechazadoReenviar(TemplateValidaLogin, VistaEdicion):
    template_name = "tramite/personal/rechazado/reenviar.html"
    model = Destino
...
class PersonalBandejaRechazadoAnular(TemplateValidaLogin, VistaEdicion):
    template_name = "tramite/personal/rechazado/anular.html"
    model = Destino
...
class PersonalBandejaRechazadoArchivar(TemplateValidaLogin, VistaEdicion):
    template_name = "tramite/personal/rechazado/archivar.html"
    model = Destino
    ...
    def get_form(self, form_class=None):
        form = super(PersonalBandejaRechazadoArchivar, self).get_form(form_class)
