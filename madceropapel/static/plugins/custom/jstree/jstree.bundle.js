 ...
 * jslint: loopfunc: true, browser: true, ass: true, bitwise: true, continue: true, nomen: true, plusplus: true, regexp: true, unparam: true, true, white: true
 */
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		...
		draw_children : function (node) {
			...
			if(!node || !node.length) { return false; } // quick toggle
 ...
 */
	...
	var drg, elm;
	// now check works by checking for each node individually, how about max_children, unique, etc?
